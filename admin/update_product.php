   ...
   <section class="update-product">
      ...
      ?>
            <form action="" method="POST" enctype="multipart/form-data">
               ...
               <span>ubah nama</span>
               <input type="text" required placeholder="masukkan nama produk" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
               <span>ubah harga</span>
               <input type="number" min="0" max="9999999999" required placeholder="masukkan harga produk" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
               ...
               <div class="flex-btn">
                  ...
                  <a href="products.php" class="option-btn">balik</a>
               </div>
            </form>
      <?php
         }
