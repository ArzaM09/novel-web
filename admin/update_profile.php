...
if (isset($_POST['submit'])) {
   ...
   if ($old_pass != $empty_pass) {
      if ($old_pass != $prev_pass) {
         $message[] = 'passweod lama tidak cocok!';
...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="POST">
         ...
         <input type="password" name="confirm_pass" maxlength="20" placeholder="konfirmasi password" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
         <input type="submit" value="ubah sekarang" name="submit" class="btn">
      </form>
