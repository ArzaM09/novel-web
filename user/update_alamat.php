...
if (isset($_POST['submit'])) {
   ...
   $address = $_POST['house'] . ', ' . $_POST['street'] . ', ' . $_POST['city'] . ', ' . $_POST['country'] . ' - ' . $_POST['pin_code'];
...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="post">
         <h3>Alamat Mu</h3>
         <input type="text" class="box" placeholder="Nomor Rumah" required maxlength="50" name="house">
         <input type="text" class="box" placeholder="Nama Jalan" required maxlength="50" name="street">
